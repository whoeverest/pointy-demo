...
Path.prototype.translate = function (x, y, z) {
  return new Path(this.points.map(function (point) {
    return point.translate.apply(point, [x, y, z]);
  }));
};
 ...
 */
Path.prototype.rotateZ = function (origin, angle) {
  return new Path(this.points.map(function (point) {
    return point.rotateZ.apply(point, [origin, angle]);
  }));
};
 ...
 */
Shape.prototype.rotateZ = function (origin, angle) {
  return new Shape(this.paths.map(function (path) {
    return path.rotateZ.apply(path, [origin, angle]);
  }));
};
...
},{"./helpers.js":14,"lodash":10}],13:[function(require,module,exports){
...
},{"jquery":9,"lodash":10}],14:[function(require,module,exports){
var _ = require('lodash');
...
},{"./helpers.js":14,"isomer":1,"jquery":9,"lodash":10}],17:[function(require,module,exports){
var _ = require('lodash');
